...
Begin VB.Form FormInputNumber 
   ...
   MaxButton       =   0   'False
   MinButton       =   0   'False
   MouseIcon       =   "FormInputNumber.frx":25CA
...
'[] COMMANDS []
    ...
    Public Sub CmdCancel_Click()
        ...
        FormMainWindow.Enabled = True: FormInputNumber.Hide
    End Sub
...
'[] SPECIAL []
    ...
    Public Sub InputNumberFinish()
        If ((inputnumber1 * 1000 + inputnumber2 * 100 + inputnumber3 * 10 + inputnumber4) < 10) Or ((inputnumber1 * 1000 + inputnumber2 * 100 + inputnumber3 * 10 + inputnumber4) > 9999) Then
            MsgBox "The quantity is limited, from 10 to 9999.", vbExclamation + vbOKOnly + vbDefaultButton1, "Number Invalid"
        Else
            FormMainWindow.totalquan = inputnumber1 * 1000 + inputnumber2 * 100 + inputnumber3 * 10 + inputnumber4
            Call FormMainWindow.Refresher
        End If
